...
export const Card: React.FC<CardProps> = ({ title, status, adress, description, date, skills }) => {
    ...
    return (
        <>
            <div className="shadow-[5px_5px_10px_0px_rgba(0,_0,_0,_0.2)] bg-white p-8 w-[430px] flex flex-col gap-5 hover:shadow-green-800 transition-shadow duration-200">
                <div className="flex flex-col gap-1">
                    <div className="flex flex-row justify-between">
                        <p className="text-[#036D3C] text-xl font-semibold">{title}</p>
                        <div className="bg-[#F5991D] flex justify-center items-center px-4 rounded-2xl text-white font-medium">{status}</div>
                    </div>
