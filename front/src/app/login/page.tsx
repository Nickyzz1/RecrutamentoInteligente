...
export default function Login() {
  return (
    <div className="flex flex-col h-screen w-screen bg-[#036D3C]">
      <div className="bg-white lg:w-4/6 fixed h-screen flex flex-col items-center w-11/12 sm:w-5/6 right-0  md:rounded-tl-[600px] lg:rounded-tl-[700px]  flex-1/4 justify-start md:p-32 p-3 gap-28">
